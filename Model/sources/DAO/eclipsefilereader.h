...
public:
    ...
    enum Cases { /*RUNSPEC*/ RUNSPEC, TITLE, START, METRIC, FIELD, LAB, UNIFOUT, OIL, WATER, GAS, DISGAS, TEMP, NOECHO, IMPLICIT, FULLIMP, IMPES,
        ...
        /*SOLUTION*/ SOLUTION, EQUIL, RSVD, PBVD, PRVD, PRESSURE, SWAT, SGAS, PBUB, RS, AQUANCON, AQUFETP,
